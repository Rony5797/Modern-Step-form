      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">
            ...
            >
              SUR United International Engineering (SUIE)
            </motion.span>
            {/* <motion.span
            ...
            >
             Powering Progress in Oman and Beyond Since 2008
            </motion.span> */}
          </h1>
          <motion.p
          ...
          >
            A subsidiary of the EXO Group, SUIE delivers world-class
            engineering, infrastructure, and resource solutions across
            industries, backed by over 100 successful projects and a legacy of
            unmatched quality.
          </motion.p>
          <motion.div
