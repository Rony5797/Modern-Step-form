        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
          ...
          {previewUrl ? (
            <div className="relative h-full w-full">
              ...
              <button
                type="button"
                onClick={() => onChange(null)} // Clear the file
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {files.map((fileField) => (
        <FileUpload
          ...
          value={doc[fileField.name]}
          onChange={(file) =>
            handleDocumentChange(docType, fileField.name, null, file)
          }
...
const StepForm = () => {
  ...
  const handleDocumentChange = (docType, field, value, file) => {
    setFormData((prev) => {
      // If it's a file upload, store the file object
      if (file !== undefined) {
        return {
          ...prev,
          [docType]: {
        ...
        // For regular input fields, update the value
        return {
          ...prev,
          [docType]: {
            ...prev[docType],
  ...
  const handleSubmit = (e) => {
      ...
      if (value instanceof File) {
        ...
        Object.entries(value).forEach(([subKey, subValue]) => {
          ...
          if (subValue instanceof File) {
            formDataToSend.append(fullKey, subValue);
          } else {
            formDataToSend.append(fullKey, subValue);
          }
        });
    ...
    // Submit formDataToSend to your API here
    console.log("Form data ready for submission:", formDataToSend);
  };
